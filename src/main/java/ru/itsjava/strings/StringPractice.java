...
//        System.out.println("builderStr.toString() = " + builderStr.toString());
        ...
        System.out.println("(str.indexOf(\"Я\")) = " + (str.indexOf("Я")));//возвращает индекс по указанному символу.
        System.out.println("(str.indexOf(\"з\")) = " + (str.indexOf("з")));
        System.out.println("(str.substring(0, 4)) = " + (str.substring(0, 4)));//возвращает подстроку строки начиная с указанного индекса и заканчивая указанным индексом
        System.out.println("(str.startsWith(\"Я\")) = " + (str.startsWith("Я"))); // возвращает true если строка начинается с указанного слова или символа
        System.out.println("(str.startsWith(\"Я стр\")) = " + (str.startsWith("Я стр")));
        System.out.println("(str.replaceAll(\"Я\", \"Это\")) = " + (str.replaceAll("Я", "Это")));//заменяет часть строки на заменяемую строку
        System.out.println("(str) = " + (str));
        String str4 = "          Я Java      ";
        System.out.println("str4.trim() = " + str4.trim());//убирает пробелы в конце и в начале строки (если есть)
        System.out.println("str4 = " + str4);
        System.out.println("str.toCharArray() = " + str.toCharArray());// не очень понял
